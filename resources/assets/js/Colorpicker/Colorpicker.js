...
{
    colorpicker.factory('Helper', function () {
      'use strict';
      return {
    ...
    colorpicker.factory('Color', ['Helper', function (Helper) {
      'use strict';
      return {
        value: {
          h: 1,
    ...
    colorpicker.factory('Slider', ['Helper', function (Helper) {
      'use strict';
      var
          slider = {
            maxLeft: 0,
    ...
    colorpicker.directive('colorpicker', ['$document', '$compile', 'Color', 'Slider', 'Helper', function ($document, $compile, Color, Slider, Helper) {
      'use strict';
      return {
        require: '?ngModel',
        restrict: 'A',
